...
export type StorageHash =
  StorageHashBase<'d85a7922b6a77ce3a8635b6a06550ed366aa732060fbd3aa00b14ee6c239fc99'>;
export type ExecutionHash =
  ExecutionHashBase<'f536571ae406f3d55e363ca38660688a410a27c8f07cce60cf84ab9e06022d0a'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly CustomerBandwidthUsage: {
      readonly id: CodecTypes['pg/uuid@1']['output'];
      readonly userId: CodecTypes['pg/uuid@1']['output'];
      readonly periodYear: CodecTypes['pg/int4@1']['output'];
      readonly periodMonth: CodecTypes['pg/int4@1']['output'];
      readonly bytesDownloaded: CodecTypes['pg/int8@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly File: {
    ...
    readonly User: {
      ...
      readonly passwordHash: CodecTypes['pg/text@1']['output'];
      readonly storageQuota: CodecTypes['pg/int8@1']['output'];
      readonly storageLimitBytes: CodecTypes['pg/int8@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly CustomerBandwidthUsage: {
      ...
      readonly periodYear: CodecTypes['pg/int4@1']['input'];
      readonly periodMonth: CodecTypes['pg/int4@1']['input'];
      readonly bytesDownloaded: CodecTypes['pg/int8@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly File: {
    ...
    readonly User: {
      ...
      readonly passwordHash: CodecTypes['pg/text@1']['input'];
      readonly storageQuota: CodecTypes['pg/int8@1']['input'];
      readonly storageLimitBytes: CodecTypes['pg/int8@1']['input'] | null;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly customerBandwidthUsage: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [
                { readonly columns: readonly ['userId', 'periodYear', 'periodMonth'] },
              ];
              indexes: readonly [
                {
                  readonly name: 'customerBandwidthUsage_userId_idx_a489d58a';
                  readonly prefix: 'customerBandwidthUsage_userId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'customerBandwidthUsage';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
...
> & {
  ...
  readonly roots: {
    ...
    readonly customerBandwidthUsage: {
      ...
      readonly model: 'CustomerBandwidthUsage';
    };
      ...
      readonly public: {
        readonly models: {
          ...
          readonly CustomerBandwidthUsage: {
            ...
            readonly storage: {
              readonly table: 'customerBandwidthUsage';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userId: { readonly column: 'userId' };
                readonly periodYear: { readonly column: 'periodYear' };
                readonly periodMonth: { readonly column: 'periodMonth' };
                readonly bytesDownloaded: { readonly column: 'bytesDownloaded' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
          ...
          readonly User: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly passwordHash: { readonly column: 'passwordHash' };
                readonly storageQuota: { readonly column: 'storageQuota' };
                readonly storageLimitBytes: { readonly column: 'storageLimitBytes' };
        ...
        readonly enum: {
          ...
          readonly AdminAuditAction: {
            ...
            readonly members: readonly [
              ...
              { readonly name: 'CUSTOMER_QUOTA_CHANGED'; readonly value: 'CUSTOMER_QUOTA_CHANGED' },
              {
                readonly name: 'CUSTOMER_LIMITS_CHANGED';
                readonly value: 'CUSTOMER_LIMITS_CHANGED';
              },
